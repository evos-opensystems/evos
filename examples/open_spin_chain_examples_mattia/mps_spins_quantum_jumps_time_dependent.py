...
qj = mps_quantum_jumps_time_dependent.MPSQuantumJumps(n_sites, lat) #ADAPTIVE TIMESTEP, NO NORMALIZATION
...
for trajectory in range(n_trajectories): 
    ...
    test_singlet_traj_evolution = qj.quantum_jump_single_trajectory_time_evolution(init_state, conf_tdvp, trajectory, obsdict, compute_H, compute_lindbl_op_list)
