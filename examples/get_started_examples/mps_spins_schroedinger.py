...
The model is a spin chain with algebraically decaying interactions and disorder.
"""
import numpy as np
import time
import os
...
try:
    ...
    os.chdir('data_schroedinger_mps')
except:
    pass
...
conf_tdvp2.gse_conf.sing_val_thresholds = [1e-12] #most highly model-dependet parameter
...
time_v = np.linspace(0, sz.shape[1]*0.05, sz.shape[1] )
...
plt.legend()
plt.xlabel('time')
fig.savefig('mps_spins_schroedinger.png')