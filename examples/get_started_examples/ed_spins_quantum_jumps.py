"""Solving the Lindblad equation with quantum jumps and exact diagonalization (ED) for a spin chain with algebraically decaying interactions, disorder and dissipation on one site."""
import evos
