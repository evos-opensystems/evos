...
for trajectory in range(n_trajectories): 
    ...
    for timestep in range(n_timesteps):
        state = ed_quantum_jumps.quantum_jump_single_trajectory_time_evolution(state, dt, dt, trajectory, obsdict,  H_tot_t(timestep_counter), l_list_tot, n_timesteps, compute_obs_for_init_state=False, timestep_for_obs_saving_shift = timestep_counter )
        timestep_counter += 1
