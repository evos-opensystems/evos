...
class MPSQuantumJumps():
    ...
    def Bisection(self, f, a, b, tol, max_iterations, n_iterations): 
        ...
        if np.abs(f(m)) < tol: #or n_iterations == max_iterations:
            ...
            return Bisection(f, m, b, tol, max_iterations,n_iterations+1)
        
        elif np.sign(f(b)) == np.sign(f(m)):
            #print('entered condition 4')
            # case where m is an improvement on b. 
            # Make recursive call with b = m
            return Bisection(f, a, m, tol, max_iterations, n_iterations+1)
    ...
    def NormDecrease(psi: ptn.mp.MPS, r1: float): -> float
    ...
    def quantum_jump_single_trajectory_time_evolution(self, psi_t: ptn.mp.MPS, conf_tdvp, t_max: float, dt: float, trajectory: int, obsdict):
        ...
        for i in range( n_timesteps ):
            ...
            if r1 > delta_p: #evolve with non-hermitian hamiltonian
                ...
                dt1, n_iterations, unconverged = Bisection(NormDecrease(),0,dt,tol,max_iterations,0)
